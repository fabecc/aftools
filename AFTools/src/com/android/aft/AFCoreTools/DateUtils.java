...
public class DateUtils {
    ...
    /**
     * <p>
     * Convert a timestamp to date and format if to a human readable format. You
     * can specify the format the date must have.
     * </p>
     ...
     * </table>
     * 
     * @param pattern The pattern to apply to the timestamp.
     * @param timestamp The timestamp in milliseconds.
     * @return The date formatted in readable format.
     */
