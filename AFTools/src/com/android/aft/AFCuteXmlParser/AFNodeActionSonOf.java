...
/**
 * Add node test to check the name of the current parent tag
 */
public abstract class AFNodeActionSonOf<CookieType> extends AFNodeAction<CookieType> {
	 ...
	 */
	public AFNodeActionSonOf(String nodeName, String parentNodeName){
		super(nodeName);
	 ...
	 * Add a test to check the name of the parent
	 *
